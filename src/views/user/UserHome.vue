<template>
  <div class="position-relative">
    <div class="container-lg">
      <div
        class="h-100 position-absolute d-flex justify-content-center
        align-items-md-center pe-4 banTitle align-items-start"
      >
        <div class="text-start">
          <h2
            class="h2 fw-bold text-wrap text-md-start pe-5 text-white d-md-block d-none text-dark"
          >
            一起前進台灣的每一個角落<br />
            美好回憶由你創造
          </h2>
          ...
          <RouterLink :to="`/products`">
            <button
              type="button"
              class="my-md-3 my-1 btn btn-primary text-white btn-lg fw-bold btnAnimate"
            >
              探索行程
            </button>
          </RouterLink>
      ...
      <img
        src="@/assets/images/personback2.png"
        class="position-absolute bottom-0 end-0 w-25 pe-4 d-md-block d-none"
        style="z-index: 10"
        alt="旅行者"
      />
    </div>
  ...
  <div class="container">
    <div class="section mt-5 mx-auto pt-4 justify-content-between introBox text-center">
      ...
      <p class="text-wrap mx-auto px-md-0 px-2 lh-base mt-3 lh-lg">
        ...
        好嗨遊讓您用最優惠的價格玩到最豐富的行程！
      </p>
      <RouterLink :to="`/products`">
        <button
          type="button"
          class="btn btn-primary text-white px-4 btnAnimate"
        >
          前往探索
        </button>
      </RouterLink>
    ...
    <div class="mt-5 pt-4 justify-content-between container px-lg-5 px-2">
      ...
      <div class="row pt-3 px-1 d-md-flex mx-auto justify-content-center">
        ...
        >
          ...
          >
            <img
              class="img-fluid border-0 rounded-top"
  ...
  <div class="container mt-5 pt-4 pb-4 justify-content-between">
    ...
    <!-- 手機版我猜你想找 -->
    <ul
      class="d-md-none d-block d-md-flex mt-4 justify-content-center
      align-items-center px-md-0 ps-0"
    >
      <li class="mx-md-2 mx-auto row pb-4">
        <div
          class="col-10 row justify-content-center align-items-center mx-auto"
        >
          <RouterLink
            :to="`/products?category=文化探索`"
          ...
          >
            <div
              class="img-fluid d-block walkImg text-decoration-none py-5 rounded-2"
            ></div>
          </RouterLink>
          <RouterLink
            :to="`/products?category=文化探索`"
      ...
      <li class="mx-md-2 mx-auto row pb-4">
        ...
        >
          ...
          >
            <div
              class="img-fluid d-block foodImg text-decoration-none py-5 rounded-2"
            ></div>
          </RouterLink>
          <RouterLink
            :to="`/products?category=美食之旅`"
      ...
      <li class="mx-md-2 mx-auto row pb-4">
        ...
        >
          ...
          >
            <div
              class="img-fluid d-block familyImg text-decoration-none py-5 rounded-2"
            ></div>
          </RouterLink>
          <RouterLink
            :to="`/products?category=親子出遊`"
      ...
      <li class="mx-md-2 mx-auto row pb-4">
        ...
        >
          ...
          >
            <div
              class="img-fluid d-block vacationImg text-decoration-none py-5 rounded-2"
            ></div>
          </RouterLink>
          <RouterLink
            :to="`/products?category=休閒渡假`"
      ...
      <li class="mx-md-2 mx-auto row pb-4">
        ...
        >
          ...
          >
            <div
              class="img-fluid d-block natureImg text-decoration-none py-5 rounded-2"
            ></div>
          </RouterLink>
          <RouterLink
            :to="`/products?category=自然景色`"
    ...
    <div class="container my-5 py-4">
      <div class="row align-items-md-center py-3 px-0 px-2 position-relative">
        <div class="col-md col-12">
          <p
            class="text-wrap activeTitle text-md-start fw-bold mb-5 activeFont"
            style="z-index: 10"
          >
        ...
        <div class="col-md col-12 position-relative activebox">
          <img
            src="@/assets/images/benner-active.png"
            class="position-absolute top-0 start-0 w-100 translate-middle-y"
            alt=""
          />
        </div>
      </div>
