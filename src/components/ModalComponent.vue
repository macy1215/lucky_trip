                  ...
                  <div v-if="Array.isArray(tempProduct.imagesUrl)">
                    ...
                    <div
                      v-if="
                        ...
                        tempProduct.imagesUrl.at(-1).trim()
                      "
                      class="my-2"
                    >
                      <button
            ...
            <div class="col-sm-12">
              ...
              <div class="row text-start">
                ...
                <div class="mb-3 col-md-6">
                  ...
                  <div
                    class="d-lg-inline-flex flex-row align-items-center mt-2"
                  >
                    ...
                    <div class="form-check me-3 form-check-inline">
                      <input
                        ...
                        value="包車"
                        id="Intercitybus"
                        v-model="tempProduct.is_intercitybus"
                        :true-value="1"
                        :false-value="0"
                      />
                    ...
                    <div class="form-check form-check-inline">
                      <input
                        ...
                        value="大眾交通"
                        id="publictrans"
                        v-model="tempProduct.is_publictrans"
                        :true-value="1"
                        :false-value="0"
                      />
              ...
              <div class="mb-3 text-start">
                ...
                <textarea
                  ...
                  type="text"
                  class="form-control"
                  placeholder="旅遊行程文字說明"
                  v-model="tempProduct.schedule"
                >
                </textarea>
              </div>
              ...
              <div class="mb-3 text-start">
                ...
                <div class="form-check ms-3 form-check-inline">
                  <input
                    ...
                    value="可包車"
                    id="needcar"
                    v-model="tempProduct.need_car"
                    :true-value="1"
                    :false-value="0"
                  />
                  <label class="form-check-label" for="needcar"> 可包車 </label>
                </div>
              </div>
              <div class="mb-3 text-start">
                ...
                <textarea
                  ...
                  class="form-control"
                  placeholder="請輸入費用內容"
                  v-model="tempProduct.feeincluded"
                >
                </textarea>
              </div>
              ...
              <div class="d-flex">
                <div class="mb-3 text-start w-25">
                  ...
                  <input
                    ...
                    min="0"
                    class="form-control"
                    placeholder="請輸入最少成行人數"
                    v-model="tempProduct.minpeople"
                  />
                </div>

                <div class="mb-3 ms-4 text-start w-25">
                  <label for="registpeople" class="form-label"
                    >可報名人數</label
                  >
                  <input
                    id="registpeople"
                    ...
                    min="0"
                    class="form-control"
                    placeholder="請輸入最多可報名人數"
                    v-model="tempProduct.regist"
                  />
                </div>
              </div>
              <!-- <div class="mb-3 text-start">
