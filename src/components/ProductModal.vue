              ...
              <div class="row">
                <div class="col-sm-4">
                  <div class="mb-2">
                    ...
                    <div v-else>
                      <button
                      class="btn btn-outline-primary btn-sm d-block w-100"  @click="createImages">
                        新增圖片
                      </button>
                    </div>
                  </div>
                ...
                <div class="col-sm-8">
                  <div class="mb-3">
                    ...
                    <input id="title"
                    type="text"
                    class="form-control" placeholder="請輸入標題"  v-model="tempProduct.title">
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="mb-3 col-md-6">
                      ...
                      <input id="unit"
                      type="text"
                      class="form-control" placeholder="請輸入單位" v-model="tempProduct.unit">
                    </div>
                  </div>
